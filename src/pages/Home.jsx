...
//   const [showRightButtons, setShowRightButtons] = useState(true); // New state for showing/hiding right buttons
//   const handleClose = () => setShowUnsavedModal(false);
...
//     setShowRightButtons(!showRightButtons);
//   };
...
//           {/* Floating action buttons (right) */}
//           <div className="absolute top-[59.666667%] right-8 flex flex-col gap-4 z-40 -translate-y-1/2">
//             {/* Menu Toggle Button */}
//             <button
//               onClick={toggleRightButtons}
//               className={`flex items-center justify-center px-4 py-2 rounded-xl text-white font-semibold text-base border border-white/30 bg-[#00000047] backdrop-blur-md shadow-lg hover:backdrop-blur-xl hover:bg-white/20 transition-all duration-300 ${showRightButtons ? 'rotate-180' : ''}`}
//               title={showRightButtons ? "Hide Menu" : "Show Menu"}
//             >
//               <svg 
//                 xmlns="http://www.w3.org/2000/svg" 
...
//             {/* Right side buttons with slide animation */}
//             <div className={`flex flex-col gap-4 transition-all duration-500 ease-in-out overflow-hidden ${showRightButtons ? 'max-h-96' : 'max-h-0'}`}>
//               {/* Full Preview Button */}
//               <button
//                 onClick={toggleFullPreview}
//                 className="flex items-center gap-2 px-4 py-2 rounded-xl text-white font-semibold text-base border border-white/30 bg-[#00000047] backdrop-blur-md shadow-lg hover:backdrop-blur-xl hover:bg-white/20 transition-all duration-200"
